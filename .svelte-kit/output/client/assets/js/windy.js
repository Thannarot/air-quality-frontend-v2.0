...
var Windy = function (params) {
  ...
  var PARTICLE_REDUCTION = 0.1;            // reduce particle count to this much of normal for mobile devices
  ...
  var interpolateField = function (grid, bounds, extent, callback) {
    ...
    var projection = {};
    var velocityScale = VELOCITY_SCALE/MAPZOOM_LAYER;
  ...
  var start = function (bounds, width, height, extent, finalParams) {
    if (finalParams && finalParams.particleLineWidth) {
      ...
      MAPZOOM_LAYER= finalParams.zoomLevel;
    }
    var mapBounds = {
